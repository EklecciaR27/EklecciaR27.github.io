...
if(isset($_POST['submit'])){
    ...
    $result = mysqli_query($db, "INSERT INTO form_pv (name, email, dob, phone, submit, message) 
    VALUES ('$name', '$email', '$dob', '$phone', '$submit', '$message')");
            ...
            <form method="post">
                <div class="input-row">
                    <div class="input-group">
                        <label>Name</label>
                        <input type="text"  name="name" id="name" placeholder="Williams S">
                    </div>
                    <div class="input-group">
                        <label>Email</label>
