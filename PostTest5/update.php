...
$result = mysqli_query($db, "SELECT * FROM form_pv WHERE id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $result = mysqli_query($db, 
    "SELECT * FROM form_pv WHERE id = '$id'");
    $row = mysqli_fetch_array($result);
    ...
    <div class="contact-box">
        <div class="contact-left">
            ...
            <form action="" method="post">
                ...
                <button type="submit" name="submit" value = <?php echo date("h:i:sa");?>>UPDATE</button>
            </form> <br>
